...
resource (or the `streak.updater.uri` system property) and expects as response
...
The `version` attribute is the string to be compared with the `ro.streak.build.version` property.  
