...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.streak.build.version";
    public static final String PROP_DEVICE = "ro.streak.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "streak.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "streak.updater.uri";
